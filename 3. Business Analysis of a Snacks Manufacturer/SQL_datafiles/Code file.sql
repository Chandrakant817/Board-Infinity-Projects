...
## in vidoe it is mention take UNIQUE Transaction_ID
...
limit 5;
---------------------------------------------------------------------------------------------------
## 4. Find the list of transactions having products from ‘produce’ type and unit price 
# more than the average unit price of ‘produce’ product type.
##Hint: Join the required tables and use where clause and subquery.

SELECT a.transaction_id, a.product_id,
